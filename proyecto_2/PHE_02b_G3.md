...
Como se ha discutido con anterioridad, vivimos en un mundo sumido por completo en las tecnologías de la información y absolutamente dependiente de estas. Este hecho es una gran muestra de la evolución tecnológica de la humanidad desde mediados del siglo 20, donde se idearon los primeros ordenadores como el ENIAC (1945) o el TRADIC (1954), los cuales llegaban a pesar toneladas y ocupar grandes espacios, pasando por los primeros ordenadores de sobremesa y llegando hasta los avanzados dispositivos que vemos en nuestros días. A medida que ha ido transcurriendo este proceso de evolución tecnológica, hemos ido observando cómo los ordenadores comenzaron su existencia naciendo como costosos equipos gubernamentales y de investigación en ámbitos universitarios, y acabaron evolucionando hasta el extremo de llegar a ser herramientas ampliamente utilizadas en todo el mundo, haciéndose progresivamente de un sitio irremplazable en nuestras vidas, alcanzando todos los estratos de la sociedad.

Este inexorable avance tecnológico trae consigo un lado incómodo y preocupante, dado que la necesidad de uso de las facilidades informáticas de este siglo implica que su irremplazabilidad puede ser explotada por malhechores, que armados con los suficientes conocimientos en materia de seguridad informática, pueden llegar a causar grandes estragos en empresas, organizaciones gubernamentales, infraestructura civil e incluso a particulares. El rápido avance en este campo demanda de manera urgente la presencia de miles de nuevos profesionales de la ciberseguridad en el mercado laboral, a fin de comprender las técnicas y herramientas utilizadas por los cibercriminales, y de este modo poder contrarrestarlos en la medida de lo posible. 

A través de la investigación y de la subsiguiente redacción de este documento hemos podido analizar las fases de ataque más comunes de los cibercriminales, así como los métodos y las herramientas que usan, con la finalidad de poder comprenderlos y anticiparnos a ellos, haciendo uso de un enfoque preventivo. Este enfoque hace uso de las Auditorías Ofensivas, que se valen de las técnicas usadas por los propios agresores, de modo que poniendo a prueba los sistemas de un cliente se evalúan las capacidades de respuesta del mismo, ofreciendo soluciones que mitiguen sus posibles futuros problemas de seguridad. 

Realmente un ataque cibernético puede llegar a causar daños devastadores tanto a los sistemas como a la reputación de una compañía, y especialmente cuando se trata de una PYME, dado que las empresas más grandes tienen a su disposición mayores recursos técnicos y económicos, pudiendo hacer frente a este contratiempo de manera más efectiva. Por este motivo es tan importante disponer de buenos profesionales en materia de ciberseguridad, a fin de poder mitigar estos daños, manteniendo seguras tanto a las empresas como a los particulares.
